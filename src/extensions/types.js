...
const imTrue = pick(9) // done

// 2. Pick a real number
const aReal = pick(4) // done

// 3. Pick a string
const aString = pick(6) // done

// 4. Pick an array
const anArray = pick(7) // done

// 5. Pick a (simple) number
const aNumber = pick(3) // done

// 6. Pick an object
const anObject = pick(8) // done

// 7. Pick false
const imFalse = pick(10) // done

// 8. Pick a BigInt
const imBigInt = pick(5) // done

// 9. Pick undefined
const imUndefined = pick(2) // done

// 10. Pick null
const imNull = pick(1) // done
